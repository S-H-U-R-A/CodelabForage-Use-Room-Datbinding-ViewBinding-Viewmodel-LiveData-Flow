...
class ForageableListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //SE VICULA LA VISTA XML CON SU CODEBEHIND
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //SE CREA EL ADAPATADOR Y SE CONFIGURA EL EVENTO CLICK
        //SOBRE CADA ITEM
        ...
        //SE OBSERVA LA LISTA DEVUELTA DE LA DB
        viewModel.allForageables.observe(
            viewLifecycleOwner
        ){
        ...
        binding.apply {
            //SE VINCULA EL ADAPTER AL RECYCLERVIEW
            recyclerView.adapter = adapter

            //CUANDO SE DA CLICK SOBRE EL FAB
