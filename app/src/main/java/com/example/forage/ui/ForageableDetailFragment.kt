...
class ForageableDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //SE VINCULA LA VISTA XML XON EL CODEBEHIND
    ...
    private fun bindForageable() {
        //SE VINCULAN LOS DATOS RECIBIDOS
        binding.apply {
